<div class="news-extract news-extract--horizontal">
    ...
    <div class="news-extract__details">
        ...
        <div class="news-extract__meta text--upper">
	        ...
	        <?php if( ! is_tax('news_categories') && ! $_POST['is_tax_news_categories'] && wp_get_post_terms(get_the_ID(), 'news_categories')) : // Don't show the news category listing is we're on a news category archive page. the POST value is used during the AJAX call when loading more stories ?>

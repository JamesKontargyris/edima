        ...
        <div class="stripe__content">
            ...
            <div class="news-footer__tweets">
                <h5 class="text--upper"><i
                            class="fa fa-lg fa-twitter"></i> <?php echo get_theme_mod( 'twitter_section_title', '@DOTEurope' ); ?>
                    <a href="https://twitter.com/intent/follow?screen_name=<?php echo get_theme_mod( 'twitter_handle', 'DOTEurope' ); ?>"
...
<footer id="colophon" class="site-footer">
    ...
    <div class="site-footer__content">
        <div class="site-footer__legal">
            &copy; DOT Europe <?php echo date( 'Y' ); ?>. All rights reserved. <br>
	        <?php
	        wp_nav_menu( array(

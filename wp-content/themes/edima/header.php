...
<div id="page" class="site">
    ...
    <header id="masthead" class="site-header <?php if ( is_front_page() ) : ?> site-header--home <?php endif; ?>"
            role="banner">
        <div class="site-header__content">


            <div class="site-header__mobile-menu-toggle-container">
                <a class="site-header__mobile-menu-toggle-icon <?php if ( is_front_page() ) : ?> site-header__mobile-menu-toggle-icon--home <?php endif; ?>"
                    ...
                    <p class="site-title margin--none">
                        ...
                        <a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home">
							<?php if ( is_front_page() ) : ?>
                                <img src="<?php echo get_template_directory_uri(); ?>/img/doteurope_logo_primary.png"
                                     alt="DOT Europe">
							<?php else : ?>
                                <img src="<?php echo get_template_directory_uri(); ?>/img/doteurope_logo_primary_reversed.png"
                                     alt="DOT Europe">
							<?php endif; ?>
                        </a>
